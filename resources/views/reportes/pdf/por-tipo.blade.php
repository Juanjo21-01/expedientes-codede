                        ...
                        <td>
                            @if ($fila['total'] > 0)
                                <div class="progress-bar">
                                    <div class="progress-fill {{ $fila['porcentaje_aprobacion'] >= 70 ? 'progress-success' : ($fila['porcentaje_aprobacion'] >= 40 ? 'progress-warning' : 'progress-error') }}"
                                        style="width: {{ $fila['porcentaje_aprobacion'] }}%;"></div>
                                </div>
                ...
                <tr>
                    ...
                    <td>
                        @php
                            ...
                            $pctGlobal = $totalGlobal > 0 ? round(($aprobadosGlobal / $totalGlobal) * 100, 1) : 0;
                        @endphp
                        {{ $pctGlobal }}%
                    </td>
                </tr>
